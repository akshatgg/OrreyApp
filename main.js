...
const main = async function () {
	...
	const presetSelector = satSettings.add(generalControls, "preset", {
		...
		"Crash with Mars": [-4.752302894710143, 1.1937240000000018, 7.7807668487346024, -34.3474, -3.3456, -29.1803, 482.17783999999915],
	...
	function updateTargetName() {
		...
		if (descBox) descBox.classList.add('planet-mode');
	}
