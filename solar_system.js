...
export class SolarSystem {
    ...
    constructor(document, scene) {
        ...
        this.sun = new Planet(document, scene, new BasicOrbit(scene, 0, 0, 0, 0, 0x000000),
            ...
            { distance: "—", period: "—", moons: "—", type: "Yellow Dwarf Star" });
        ...
        this.planets.push(
            new Planet(
                document, scene, new BasicOrbit(scene, 3.87032, 3.78731, 1.59091, 0, 0x9370db, 7*Math.PI/180),
                 ...
                 { distance: "0.39 AU", period: "88 days", moons: "0", type: "Rocky Planet" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "0.72 AU", period: "225 days", moons: "0", type: "Rocky Planet" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "1.0 AU", period: "365 days", moons: "1", type: "Rocky Planet" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "1.52 AU", period: "687 days", moons: "2", type: "Rocky Planet" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "5.2 AU", period: "11.9 years", moons: "95", type: "Gas Giant" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "9.5 AU", period: "29.5 years", moons: "146", type: "Gas Giant" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "19.2 AU", period: "84 years", moons: "27", type: "Ice Giant" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "30.1 AU", period: "165 years", moons: "16", type: "Ice Giant" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "2.77 AU", period: "4.6 years", moons: "0", type: "Dwarf Planet" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "39.5 AU", period: "248 years", moons: "5", type: "Dwarf Planet" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "43.1 AU", period: "283 years", moons: "2", type: "Dwarf Planet" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "45.8 AU", period: "306 years", moons: "1", type: "Dwarf Planet" })
        )
        this.planets.push(
            new Planet(
                ...
                { distance: "67.7 AU", period: "559 years", moons: "1", type: "Dwarf Planet" })
        )
    }
